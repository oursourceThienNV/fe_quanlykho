...
export class ProductListComponent implements OnInit {
  ...
  setPage(pageInfo) {
    ...
    this.productService.search({
      pageNumber: '0',
      pageSize: 10,
      pno:this.stringNullOrEmpty(this.searchForm.get("pno").value)? {contains:this.searchForm.get("pno").value}:null,
      pname:this.stringNullOrEmpty(this.searchForm.get("pname").value)? {contains:this.searchForm.get("pname").value}:null,
