...
export const MENU: MenuItem[] = [
    ...
    subItems: [
      {
        ...
        link: '/pages/mng-standard',
        parentId: 1,
      },
      {
        id: 3,
        label: 'Quản lý chi tiêu',
        link: '/pages/cat-targets',
        parentId: 1,
      },
      {
        id: 4,
        label: 'Danh mục chung',
        link: '/pages/category/cat-item',
        parentId: 1
      },
      {
        id: 5,
        label: 'Danh mục loại sản phẩm',
        link: '/pages/cat-product-type',
        parentId: 1
      },
      {
        id: 6,
        label: 'Danh mục thiết bị thí nghiệm',
        link: '/pages/cat-machines',
        parentId: 1
      },
      {
        id: 6,
  ...
  {
    id: 10,
    label: 'Quản lý thí nghiệm',
    icon: 'bxs-shopping-bag',
    subItems: [
      {
        id: 11,
        label: 'Quản lý mẫu vật',
        link: '/pages/sample-manage',
        parentId: 10
      },
      {
        id: 12,
        label: 'Quản lý dữ liệu phòng thí nghiệm',
        link: '/pages/lab-data-raw-manage',
        parentId: 10
      },
      {
        id: 13,
        label: 'Quản lý yêu cầu',
        link: '/pages/cat-requirements',
        parentId: 10
      },
      {
        id: 14,
        label: 'Báo cáo dữ liệu tổ BTP ',
        link: '/pages/lab-data-raw-manager-report',
        parentId: 10
      }
    ]
  }
